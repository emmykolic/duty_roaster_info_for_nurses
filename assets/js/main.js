...
(function(){
    ...
    // Make A Patient Discharge Column
    // $('.discharge').on('click', function() {
    //     var checkbox = $(this);
    //     var pid = checkbox.data('pid');

    //     if (checkbox.is(':checked')) {
    //         // Make AJAX request to delete data from the database
    //         $.ajax({
    //             url: 'delete_patients.php',// Replace with your server-side script to delete data
    //             type: 'POST',
    //             data: { pid: pid },
    //             success: function(response) {
    //                 console.log('Checkbox deleted successfully.');
    //                 // Remove the checkbox element from the DOM
