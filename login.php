        ...
        <div class="col-sm-6 col-sm-offset-3">
          ...
          <form role="form" method="post" action="login_action.php">
            ...
            <div class="form-group">
              <label class="sr-only" for="phone">Phone Number or email</label>
              <input class="form-control" type="text" id="phone" name="phone" placeholder="Your Email Address*" required="required" data-validation-required-message="Please enter your Phone Number." />
